...
import { createRoleAction, fetchPermissionsAction } from "@/lib/actions";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setGlobalError(response.error || "Failed to create role");
      }
    } catch (error: any) {
            ...
            <div className="mb-12 space-y-4">
               ...
               <div className="flex justify-between items-end">
                  <div className="space-y-2">
                     <h1 className="text-5xl font-black text-gray-900 tracking-tight leading-none">New Role</h1>
                     <p className="text-gray-500 font-medium italic">Define a new role within the system.</p>
                  </div>
               </div>
            </div>
